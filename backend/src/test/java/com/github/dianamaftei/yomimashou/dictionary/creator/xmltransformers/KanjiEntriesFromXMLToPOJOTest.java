...
class KanjiEntriesFromXMLToPOJOTest {
  ...
  @Test
  void fillDatabaseShouldAddAllCharactersToTheDatabase() {
  ...
  @Test
  void fillDatabaseShouldParseKanjiComponentsCorrectly() {
    List<Character> characters = dictionaryFile.getCharacter();
  ...
  @Test
  void fillDatabaseShouldParseKanjiDictionaryReferencesCorrectly() {
    List<Character> characters = dictionaryFile.getCharacter();
    characters.add(getAMockCharacter());
    kanjiEntriesFromXMLToPOJO.saveToDB(characters);
    verify(kanjiRepository).save(kanjiArgumentCaptor.capture());
  ...
  @Test
  void fillDatabaseShouldAddKanjiAndKanjiVariantsIfThereAreAny() {
    List<Character> characters = dictionaryFile.getCharacter();
    Character mockCharacter = new Character();
