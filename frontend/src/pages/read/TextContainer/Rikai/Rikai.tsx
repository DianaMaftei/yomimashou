...
export class Rikai extends React.Component {
    ...
    toggleOutsideClickHandler() {
        this.props.setPopupInfo({
            ...
            disableOutsideClickHandler: !this.props.popupInfo.disableOutsideClickHandler
        });
    }
    ...
    render() {
        ...
        switch (this.props.popupInfo.type) {
            ...
            case (PopupType.KANJI) :
                popUpComponent =
                    <RikaiKanji style={style} result={result.result} showWordExamples={this.props.updateSearchResult}
                                changePopup={this.changePopupType.bind(this)}
                                showPreviousWord={this.showPreviousWord.bind(this)}/>
                break;
            case(PopupType.RTK) :
                ...
                break;
            case(PopupType.DRAW) :
                popUpComponent = <KanjiDrawPad character={result.result.character} open={true} style={style}
                                               changePopup={this.changePopupType.bind(this)}/>
                break;
            case(PopupType.ADD) :
                ...
                popUpComponent = <AddToDeck style={style} item={item} changePopup={this.changePopupType.bind(this)}
                                            toggleOutsideClickHandler={this.toggleOutsideClickHandler.bind(this)}/>
                break;
        ...
        return (
            <OutsideClickHandler onOutsideClick={this.hidePopup}
                                 disabled={this.props.popupInfo.disableOutsideClickHandler}>
                {popUpComponent}
            </OutsideClickHandler>
        )
    }
